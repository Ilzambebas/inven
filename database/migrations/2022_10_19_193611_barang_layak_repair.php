...
return new class extends Migration
{
    ...
    public function up()
    {
         Schema::create('barang_return_layak_repair', function (Blueprint $table) {
            $table->id();
            $table->integer('id_barang_return_layak_repair');
            $table->integer('id_user');
            $table->string('deskripsi_barang')->nullable();
            $table->string('nopo_barang')->nullable();
            $table->string('nama_pic_barang')->nullable();
            $table->integer('jumlah_barang_return_layak_repair')->nullable();
    ...
    {
        Schema::dropIfExists('barang_return_layak_repair');
    }
};
